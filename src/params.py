...
default_environment_factors = {
    ...
    "predator_chance": random.uniform(0.1, 0.5),  # Chance of a predator event
    "predator_threshold": 150,  # Population threshold to trigger predator event
...
random_parameters = {
    ...
    "foraging_efficiency": random.uniform(0.5, 2.0),
